...
exports = module.exports = function(app, passport) {
   ...
   */
  // views
  app.get('/post/create*', ensureAuthenticated);
  app.get('/post/create', require('./views/post').create);
  app.get('/post/create/:id', require('./views/post').create);
  app.get('/post/:id', require('./views/post').one);

  // REST APIs
  app.get('/1/post', require('./views/api/post').read);
  app.get('/1/post/:id', require('./views/api/post').read)
  app.all('/1/post*', ensureAuthenticated);
  app.post('/1/post', require('./views/api/post').create);
  app.put('/1/post', require('./views/api/post').create);
  app.put('/1/post/:id/publish', require('./views/api/post').activate);      
  app.put('/1/post/:id/unpublish', require('./views/api/post').inactivate);    
   ...
   * Uploader Subsystem
   */
  app.post('/1/upload/:type', require('./views/api/uploader').init);
