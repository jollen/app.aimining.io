...
app.configure(function(){
  ...
  app.set('cdn-server', config.cdnServer);
  app.set('cache-breaker', config.cacheBreaker);
  ...
  app.locals.cacheBreaker = app.get('cache-breaker');
...
app.server.listen(app.get('port'), function(){
  console.info(app.locals.projectName + ' ' + app.get('env') + ' server listening on port ' + app.get('port'));
});
